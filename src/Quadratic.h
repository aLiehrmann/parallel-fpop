...
public:
    ...
    /**
     * @details Instantiates a quadratic form whose coefficients value is zero.
     */ 
    Quadratic();
    
    /**
     * @details Instanciates the quadratic form a0 + a1*mu +a2*mu^2 .
     */
    Quadratic(double a0, double a1, double a2);
    
    /**
     * @details Adds the coefficients a0, a1, a2 to the coefficients of the current quadratic form.
     */
